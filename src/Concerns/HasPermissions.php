...
trait HasPermissions
{
    ...
    {
        return $this->belongsToMany(config('alcomponente.models.permission'))->withTimestamps();
    }

    /**
     * The mothergoose check. Runs through each scenario provided
     * by Alcomponente - checking for special flags, role permissions, and
    ...
    {
        return Alcomponente::permission()->whereIn('slug', $permissions)->get();
    }
